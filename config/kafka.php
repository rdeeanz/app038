...
return [
    /*
     ...
     | Supports multiple brokers: broker1:9092,broker2:9092,broker3:9092
     */
    'brokers' => env('KAFKA_BROKERS', 'kafka:9092'),

    /*
     | Fallback Kafka brokers for high availability
     */
    'brokers_fallback' => env('KAFKA_BROKERS_FALLBACK', 'kafka_fallback:9092'),
    ...
    /*
     | Enable fallback to secondary broker on connection failure
     */
    'enable_fallback' => env('KAFKA_ENABLE_FALLBACK', true),

    /*
     | Connection timeout in seconds
     */
    'connection_timeout' => env('KAFKA_CONNECTION_TIMEOUT', 5),

    /*
     | Retry attempts for connection
     */
    'connection_retry_attempts' => env('KAFKA_CONNECTION_RETRY_ATTEMPTS', 3),

    /*
     | Retry delay in seconds between connection attempts
     */
    'connection_retry_delay' => env('KAFKA_CONNECTION_RETRY_DELAY', 1),
];
